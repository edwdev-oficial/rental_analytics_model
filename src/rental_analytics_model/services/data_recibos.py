...
def load_data_recibos(lista_unicos, df_valores_locacao, df_contratos):
    ...
    xlsx_files = [f for f in lista_unicos if f.type == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"]

    df_normal_itens = load_normal_itens()
    # df_valores_locacao = load_xlsx(xlsx_files)    
    ...
    df_recibos['Modelo'] = df_recibos['Linha'] + ' ' + df_recibos['Modelo']    
